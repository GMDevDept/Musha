STRINGS.musha = {
    ...
    skills = {
        ...
        launchelement = {
            rollingmagma = {
                name = "沸滚熔岩",
                desc = "默认快捷键：R\n向鼠标指定方向掷出沸腾的熔岩块，造成伤害并使温度快速升高\n（元素准备就绪时，可以再次按R键发射当前装填的元素，或按G键在所有可用元素间进行切换）",
                ready = "[沸滚熔岩] 准备就绪!",
            },
            chargedrollingmagma = {
                name = "沸滚熔岩·裂变",
            ...
            chargedwhitefrost = {
                name = "奔涌白霜·冰河",
                desc = "装填奔涌白霜时可以通过再次长按快捷键进行蓄力，蓄力完成后当前元素将得到强化\n向鼠标指定方向发射聚能压缩后的霜冻之星，命中地面时生成大范围霜冻力场，范围内目标会产生持续性降温、减速和叠加冰冻值效果。霜冻力场消失时将会对范围内目标造成一次冰爆",
            },
            poisonspore = {
                name = "孢子炸弹",
            ...
            chargedbloomingfield = {
                name = "绽放之蕊·花轮",
                desc = "装填绽放之蕊时可以通过再次长按快捷键进行蓄力，蓄力完成后当前元素将得到强化\n向鼠标指定方向发射聚能压缩后的绽放之星，命中地面时生成大范围绽放领域，范围内所有友方单位获得持续的生命回复与耐力回复，同时获得移动速度加成。此外，范围内的非友方单位每隔一段时间都会有几率强制进入睡眠状态",
            },
        },
        stronggrip = {
            name = "强力持握",
