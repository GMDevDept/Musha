...
* 技能施放全程角色处于霸体状态，并且被攻击时受到的伤害额外降低50%
* 无消耗，无冷却时间
...
* 默认快捷键：G
* 通常或充盈状态下长按快捷键可以释放[暗影波动](#1103-暗影波动)并激活暗影模式，暗影波动会对周围敌人造成最多六次AOE伤害，AOE范围逐渐扩大，基础伤害随角色等级提高。释放期间角色自身无敌
...
* 消耗：施放需要当前魔力值大于等于10（但施放时并不消耗魔力值）。护盾持续期间角色每秒消耗1点魔力值，魔力值耗尽三秒后护盾消失。主动取消或受到伤害破碎时消耗10点魔力值
* 冷却时间：30秒（从效果结束时开始计算）
