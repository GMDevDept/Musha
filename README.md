...
* 击杀怪物和敌对生物时会根据击杀目标生命值上限为Musha恢复生命值和理智值
...
* 注：完全冰冻状态下无法使用技能，但在碎冰阶段可以使用技能并解除冰冻
...
* 冲锋过程中角色处于霸体状态，并且被攻击时受到的伤害额外降低75%
...
* 暗影模式下，Musha的最大理智值将会锁定为50点，同时获得每秒5点理智回复及反转降san光环效果（参考蜂王帽）
