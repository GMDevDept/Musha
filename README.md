...
### 精灵魔法
   ...
   1. 右键点击角色可以根据当前角色模式施放精灵魔法
   2. 唤冰法咒
      1. 通常状态和充盈状态下可以使用
      2. 效果：以角色为中心对周围大范围内目标叠加冰冻累计，若目标冰冻抗性较高或免疫冰冻则会对其额外追加减速debuff，移动速度降低70%持续5秒
      3. 消耗：施法需要当前魔力值大于等于15，实际消耗魔力值为5*命中目标数量，若超过15则按15点计算
      4. 冷却时间：5秒
      5. 施法动作中角色处于霸体状态
   3. 雷霆法咒
      1. 女武神模式下可以使用
      2. 效果：以角色为中心对周围中范围内目标降下落雷，造成伤害并施加麻痹debuff
         1. 落雷：基础伤害为20点，角色等级每提高5级增加5点，享受雷属性伤害加成（如潮湿状态）并触发目标的充电效果
         2. 麻痹：20秒内攻击内置冷却时间加倍（对部分生物无效，如触手），每2秒受到5点伤害，并在发起攻击时受到额外伤害
...
### 精灵护盾
   ...
   5. 达成一定条件时，技能精灵护盾将被替换为公主庇佑
      1. 效果：为角色自身**及周围大范围内友方单位**施加精灵护盾，**持续时间15秒**，护盾持续期间目标处于无敌状态，**护盾没有承受伤害上限**，不会因敌人攻击而破碎
      2. 消耗：施放需要当前魔力值**大于等于50**，施放时，若范围内没有除角色自身以外的友方单位，则只消耗30点；反之，只要有任何其他友方单位享受到了护盾效果则消耗50点
