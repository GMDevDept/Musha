...
return {
    ...
    ANNOUNCE_BOOMERANG = "木头砸到Musha了！ Musha要扔掉那块坏木头！",
    ANNOUNCE_CHARLIE = "有东西跟着Musha！",
    ANNOUNCE_CHARLIE_ATTACK = "别打Musha的头！Musha会打你的！",
    ANNOUNCE_COLD = "啊！Musha的手指僵住啦！",
    ANNOUNCE_HOT = "Musha的鞋底好热！",
    ANNOUNCE_DUSK = "太阳下山啦！\nMusha得准备点个灯！",
    ANNOUNCE_EAT =
    {
        GENERIC = "好吃！",
    ...
    ANNOUNCE_NOSLEEPONFIRE = "Musha不要在这里躺下！\n Musha的背会着凉的！",
    ANNOUNCE_NODANGERSIESTA = "Musha听到了什么。Musha得去看看。",
    ANNOUNCE_NONIGHTSIESTA = "在这休息太冷了！",
    ANNOUNCE_NONIGHTSIESTA_CAVE = "这里真冷！",
    ANNOUNCE_NOHUNGERSIESTA = "Musha肚子饿啦！Musha要食物！",
    ANNOUNCE_SHELTER = "好像挺舒服。",
    ANNOUNCE_BURNT = "奇怪的木制品...",
    ANNOUNCE_TOOL_SLIP = "哇？",
    ANNOUNCE_DAMP = "呃 噢！",
    ANNOUNCE_WET = "很难弄干啊。",
    ANNOUNCE_WETTER = "湿哒哒的。",
    ANNOUNCE_SOAKED = "Musha想要换内衣...",
    ANNOUNCE_HOUNDS = "你听到了吗？猎犬正靠近。",
    --ANNOUNCE_HUNGRY = "Musha要吃肉。有人吗？",
    ANNOUNCE_HUNGRY = "肚子好饿..",
    ANNOUNCE_HUNT_BEAST_NEARBY = "Musha看见它了！好大一只！",
    ANNOUNCE_HUNT_LOST_TRAIL = "Musha找不到脚印了。\n 那是只大鸟吗？",
    ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "泥巴把足迹抹去了！Musha讨厌泥巴。",
    ANNOUNCE_ACCOMPLISHMENT = "上吧，弓箭！上吧！离开这里！",
    ...
    ANNOUNCE_PECKED = "坏鸟！",
    ANNOUNCE_TORCH_OUT = "另一个火把呢！",
    ANNOUNCE_WORMHOLE = "Musha讨厌粘液。",
    ...
    DESCRIBE =
    {
        ...
        MUSHA_EGG = "一颗小小的花蕾。",
        MUSHA_EGGS1 = "Yamche准备好探索这个世界啦。",
        MUSHA_EGGS2 = "Yamche的花蕾越长越大了。",
        MUSHA_EGGS3 = "它现在非常大。",
        MUSHA_EGG1 = "Yamche强壮得可以战斗了。",
        MUSHA_EGG2 = "它现在非常大。",
        MUSHA_EGG3 = "噢，Yamche睡了个好觉。",
        MUSHA_EGG8 = "没有人能够拦住我们！",
        MUSHA_EGG_CRACKED = "一个很小的花蕾。",
        MUSHA_EGG_CRACKEDS1 = "Musha在等Yamche！",
        MUSHA_EGG_CRACKEDS2 = "真是个大花蕾，不是吗？",
        MUSHA_EGG_CRACKEDS3 = "它现在非常大。",
        MUSHA_EGG_CRACKED1 = "快点！",
        MUSHA_EGG_CRACKED2 = "一个很大的花蕾。",
        MUSHA_EGG_CRACKED3 = "噢，Yamche要醒来了！",
        MUSHA_EGG_CRACKED8 = "Musha在等Yamche！",

        MUSHA_SMALL = "哇，好可爱！\n命令：(Z,V,B)",

        MUSHA_TEEN = "Yamche虽然是只小鸟，但是很勇敢！\n命令：(Z,V,B)",
        MUSHA_TEENR1 = "Yamche虽然是只小鸟，但是很勇敢！\n命令：(Z,V,B)",
        MUSHA_TEENR2 = "Yamche虽然是只小鸟，但是很勇敢！\n命令：(Z,V,B)",
        MUSHA_TEENR3 = "Yamche虽然是只小鸟，但是很勇敢！\n命令：(Z,V,B)",
        MUSHA_TEENR4 = "Yamche虽然是只小鸟，但是很勇敢！\n命令：(Z,V,B)",
        MUSHA_TEENICE = "Yamche虽然是只小鸟，但是很勇敢！\n命令：(Z,V,B)",

        MUSHA_TALL = "Yamche有足够的力量去打蜘蛛。\n命令：(Z,V,B)",
        MUSHA_TALLR1 = "Yamche有足够的力量去打蜘蛛。\n命令：(Z,V,B)",
        MUSHA_TALLR2 = "Yamche有足够的力量去打蜘蛛。\n命令：(Z,V,B)",
        MUSHA_TALLR3 = "Yamche有足够的力量去打蜘蛛。\n命令：(Z,V,B)",
        MUSHA_TALLR4 = "Yamche有足够的力量去打蜘蛛。\n命令：(Z,V,B)",
        MUSHA_TALLRICE = "Yamche有足够的力量去打蜘蛛。\n命令：(Z,V,B)",

        MUSHA_TALL2 = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",
        MUSHA_TALLRR1 = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",
        MUSHA_TALLRR2 = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",
        MUSHA_TALLRR3 = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",
        MUSHA_TALLRR4 = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",
        MUSHA_TALLRR5 = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",
        MUSHA_TALLRRICE = "谁更厉害？Yamche还是牛牛？\n命令：(Z,V,B)",

        MUSHA_TALL3 = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",
        MUSHA_TALLRRR1 = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",
        MUSHA_TALLRRR2 = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",
        MUSHA_TALLRRR3 = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",
        MUSHA_TALLRRR4 = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",
        MUSHA_TALLRRR5 = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",
        MUSHA_TALLRRRICE = "Yamche是Musha的强力搭档！\n命令：(Z,V,B)",

        MUSHA_TALL4 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRR1 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRR2 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRR3 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRR4 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRR5 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRR6 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRICE = "Yamche有超能力！\n命令：(Z,V,B)",

        MUSHA_TALL5 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRR1 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRR2 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRR3 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRR4 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRR5 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRR6 = "Yamche有超能力！\n命令：(Z,V,B)",
        MUSHA_TALLRRRRRICE = "Yamche有超能力！\n命令：(Z,V,B)",
        ...
        MUSHA_RP6 = "没人能够阻止我们！\n命令：(Z,V,B)",
        MUSHA_RP7 = "没人能够阻止我们！\n命令：(Z,V,B)",
        MUSHA_RPICE = "没人能够阻止我们！\n命令：(Z,V,B)",

        GHOSTHOUND = "走吧，幽灵伙计！",
        GHOSTHOUND2 = "噢，Musha不是故意的。",
        SHADOWMUSHA = "噢，Musha的影子要觉醒了！",
        --item
        MUSHA_FLUTE = "Yamche喜欢Musha的声音。",
        MUSHASWORD_BASE = "这是Musha的剑！",
        MUSHASWORD = "火焰！听从Musha指挥！", -- War3 Pandaren Brewmaster
        MUSHASWORD_FROST = "风暴！听从Musha指挥！", -- War3 Pandaren Brewmaster
        ...
        HAT_MPHOENIX = "战神的头盔！Musha很想要！",
        HAT_MPRINCESS = "Musha的皇冠回来了！", --grow up : Queen crown
        HAT_MBUNNY = "侦查开始。", -- Lol Caitlyn
        ARMOR_MUSHAA = "看见这件装备了吗？\n是的。这是Musha的基本装备。",
        ARMOR_MUSHAB = "这是Musha最好的盔甲。",
        --WIP
        GLOWDUST = "尝起来甜甜的。",
        CRISTAL = "发光的糖果！",
        EXP = "经验精华！",
        ...
        BOOK_GARDENING = "植物都爱这本书。",
        BOOK_SLEEP = "一本烦人的书，弄得Musha犯困",
        BOOK_BRIMSTONE = "这书不好..",
        ...
        {
            COOKING_LONG = "这要煮好久。",
            COOKING_SHORT = "这一会就煮好了。",
            DONE = "Musha喜欢那个！你呢？",
            EMPTY = "没有人使用。现在轮到Musha了。",
            BURNT = "为什么那石头烧坏了。",
        },
        EYEBRELLAHAT = "这工具能完美的遮雨、挡热、还有雪，但它很重。",
        ARMORDRAGONFLY = "如果有人碰到Musha，他们会烧起来。",
        DRAGON_SCALES = "这很酷！噢，不是冷。",
        DRAGONFLYCHEST = "这箱子可以吸收火焰，但它不能燃烧！",
        -- DECIDUOUSTREE =
        -- {
        --     BURNING = "哇啊啊啊！",
        --     BURNT = "一棵瘦小的黑树。",
        ...
        TENT =
        {
            GENERIC = "Musha能在那儿休息好久。",
            BURNT = "Musha的基地被烧成灰啦。",
        },
        SIESTAHUT =
        {
            GENERIC = "至少这个没有伞也可以让我干爽。",
            BURNT = "Musha干爽的地方被烧掉了。",
        },
        ...
        BEEBOX =
        {
            ...
            NOHONEY = "Musha不想等里面的液体黄金。",
            SOMEHONEY = "噢，蜜蜂还在工作。",
            BURNT = "Musha不喜欢烤熟的蜂蜜...",
        },
        LIVINGTREE = "树上的脸弄得Musha以为它是活的。",
        ICESTAFF = "这让Musha安全。",
        ...
        NIGHTMARE_TIMEPIECE = --Keeps track of the nightmare cycle
        {
            ...
            STEADY = "事情对Musha来说变得越来越糟！", --Nightmare 33% - 66%
        ...
        FLOWER = "Musha也许能用很多这个做点什么",
        FLOWERHAT = "一个花环。它让Musha感觉很好。",
        FLOWER_EVIL = "额，这花很难闻，不像其他的",
        FOLIAGE = "Musha从洞里得到的。",
        FOOTBALLHAT = "它能让Musha脑袋安全！",
        FROG =
        {
            DEAD = "死的青蛙就是好青蛙。",
            GENERIC = "Musha不喜欢打Musha的青蛙...",
        ...
        ACCOMPLISHMENT_SHRINE = "Musha讨厌那箭！",
    },
    DESCRIBE_TOODARK = "光尘呢？\n Musha现在需要更多的光！",
    DESCRIBE_SMOLDERING = "噢噢噢噢！",
    EAT_FOOD =
    {
        TALLBIRDEGG_CRACKED = "这很好吃，不过肉块更好吃。",
    },
}
