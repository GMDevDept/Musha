...
local function fn()
    ...
    if not TheWorld.blockduplicatelightningsound then
        ...
        TheWorld.blockduplicatelightningsound = true

        TheWorld:DoTaskInTime(0.1, function()
            TheWorld.blockduplicatelightningsound = nil
        end)
    end
...
return Prefab("lightning_musha", fn, assets)
